...
const ESTIMATOR_OPTIONS = {
  ...
  pages: [
    ...
    { id: "3", label: "2–3 pages", mult: 200 },
    { id: "5", label: "4–5 pages", mult: 500 },
    { id: "10", label: "6–10 pages", mult: 1200 },
    { id: "15+", label: "10+ pages", mult: 2200 },
  ],
  features: [
    { id: "cms", label: "CMS éditable", cost: 600 },
    { id: "blog", label: "Blog / journal", cost: 400 },
    { id: "seo", label: "SEO avancé", cost: 500 },
    { id: "ecom", label: "Mini e-commerce", cost: 1200 },
    { id: "calendar", label: "Réservation / calendrier", cost: 500 },
    { id: "maps", label: "Carte interactive", cost: 250 },
    { id: "anim", label: "Animations premium", cost: 800 },
    { id: "i18n", label: "Bilingue FR/EN", cost: 600 },
  ],
  urgency: [
